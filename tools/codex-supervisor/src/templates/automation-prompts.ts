...
export function buildReporterAutomationPrompt(): string {
  return joinLines([
    ...
    "- Send critical failures, blockers, and `review_pending` states to the thread immediately.",
    "- Send successful runs as heartbeat summaries rather than immediate spam.",
...
export function buildSprintAutomationPrompt(): string {
  return joinLines([
    ...
    "- Important failures must be reported immediately; successful cycles can be batched into heartbeat summaries.",
