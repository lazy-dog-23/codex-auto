...
- Quote `automation_state`, `ready_for_automation`, `next_automation_reason`, and `report_thread_id` directly from the latest CLI output instead of inferring from older observations.
